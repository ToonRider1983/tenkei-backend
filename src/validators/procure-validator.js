...
const procureSchema = Joi.object({
  Order_No: Joi.string().optional().allow(''), // หมายเลขคำสั่ง (Short Text)
  Procure_No: Joi.string().optional().allow(''), // หมายเลขการจัดซื้อ (Short Text)
  OdPc_No: Joi.string().optional().allow(''), // หมายเลข OdPc (Short Text)
  ...
  Vendor_CD: Joi.string().allow(null).optional(),  // รหัสผู้จำหน่าย (Short Text)
  Pc_Name: Joi.string().optional().allow(''), // ชื่อการจัดซื้อ (Short Text)
  Pc_Material: Joi.string().optional().allow(''), // วัสดุการจัดซื้อ (Short Text)
  Pc_Mate_Docu: Joi.string().optional().allow(''), // เอกสารวัสดุการจัดซื้อ (Short Text)
  Temp_Price: Joi.string().optional().allow(''), // ราคาชั่วคราว (Price CD)
  ...
  Short_Text_1: Joi.string().optional().allow(''), // ข้อความสั้น 1 (Short Text)
  ...
  Pc_Unit_CD: Joi.string().optional().allow(''), // รหัสหน่วยการจัดซื้อ (Short Text)
  Pc_Person_CD: Joi.string().optional().allow(''), // รหัสบุคคลที่ทำการจัดซื้อ (Short Text)
  Pc_Date: Joi.date().optional().allow(null), // วันที่การจัดซื้อ
  Pc_Req_Delivery: Joi.date().optional().allow(null), // วันที่ขอการจัดส่ง
  Pc_Req_Delivery_CD: Joi.string().optional().allow(''), // รหัสการขอการจัดส่ง (Short Text)
  Pc_Ans_Delivery: Joi.date().optional().allow(null), // วันที่ตอบการจัดส่ง
  Pc_Ans_Delivery_CD: Joi.string().optional().allow(''), // รหัสการตอบการจัดส่ง (Short Text)
  Pc_Delivery_Judge: Joi.string().optional().allow(''), // การตัดสินการจัดส่ง (Short Text)
  Pc_Progress_CD: Joi.string().optional().allow(''), // รหัสความก้าวหน้า (Short Text)
  ...
  Procure_Docu: Joi.string().optional().allow(''), // เอกสารการจัดซื้อ (Hyperlink)
  Pc_Remark: Joi.string().optional().allow(''), // หมายเหตุการจัดซื้อ (Short Text)
